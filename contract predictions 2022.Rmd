...
* Restricted free agents **John Collins** and **Jarrett Allen** cashed in, signing 5-year deals with their current teams.
    + Collins' deal with the Atlanta Hawks is worth [`$125M`](https://nba.nbcsports.com/2021/08/04/john-collins-re-signing-with-hawks-on-five-year-125m-contract/), while Allen got [`$100M`](https://bleacherreport.com/articles/2946293-jarrett-allen-re-signs-with-cavaliers-on-5-year-100m-contract-in-free-agency)
